 ...
 *
 * Per-model weekly buckets (Opus / Sonnet / Fable) exist too, but their exact
 * header names are undocumented and have changed before, so this collects
 * *every* `-<bucket>-utilization` header rather than a fixed list. Unknown
 * buckets surface in the UI under their raw name.
 *
